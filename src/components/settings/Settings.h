...
// FIXED: Added static_cast for enum comparison
if (static_cast<GaugeStyle>(gaugeStyle) != settings.PTS.gaugeStyle) {
...
// FIXED: Added static_cast for enum comparison
if (static_cast<WeatherFormat>(weatherFormat) != settings.PTS.weatherFormat) {
...
// FIXED: Added static_cast for enum comparison
if (static_cast<WeatherFormat>(format) != settings.PTS.weatherFormat) {
